...
// mousedown function is used to get initial value when slider moves.
mouseDown(event) {
...
// mouseup function not necessary anymore.
// mouseUp(event) {
...
currentValue() {
  ...
  currentVal = document.getElementById('bottomSlideBar').value
  // console.log('currentval: ' + currentVal)
  return currentVal
}
...
numberOfChanges(event) {
  // console.log('changestart: ' + currentVal)
